...
#define STRING_CONFIG_H_AUTHOR "(Oswel_Salcedo)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "FLSun I3 Plus"
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKp 419.32
  #define DEFAULT_bedKi 81.25
  #define DEFAULT_bedKd 541.03
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 36, -5, -4.9}
